...
class UpdateExhibitionRequest extends FormRequest
{
    ...
    {
        return [
            'type' => ['sometimes', Rule::enum(ExhibitionType::class)],
            'status' => ['sometimes', Rule::enum(ExhibitionStatus::class)],
            ...
            'translations.*.slug' => ['required', 'string', new Slug($this->route('exhibition'))],
            ...
            'media.*.id' => ['sometimes', 'integer', Rule::exists('exhibition_media', 'id')],
